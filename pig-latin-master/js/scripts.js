...
for (var i = 0; i < input.length; i++) {
  if (vowels.includes(input.charAt(i))) {
    var oneVowell = (input.slice(0, i + 1));
    var twoVowell = (input.slice (i + 1));

  // } else if (vowels.includes(input.charAt(i))) {
  //   break;
  //   var sliceArray = [input.slice(0, i + 1)];
  //   var otherArray = [input.slice(i + 1)];
    //inputArray.push(input +"way");
    vowelArray.push(oneVowell + twoVowell + "way");
    break;
  }
